...
int main()
{
    cout << "Non-Restoring Division" << endl << endl;
    int ac=0, m, q, count;
    cout << "Enter divident(Q): ";
    cin >> q;
    ...
    if(v[0]=="1") {
        cout << "AC is Negative... Doing AC = AC + M" << endl;
        string pstadd=addition(v[0], v[1], M);
        cout << pstadd[0] << "\t";
        cout << pstadd.substr(1) << "\t";
        cout << v[2] << "\t\t" << endl << endl;
        
        cout << "===================Results===================" << endl;
        cout << "Quotient is: " << v[2] << " = " << binaryToDecimal(v[2]) << endl;
        cout << "Remainder is: " << pstadd.substr(1) << " = " << binaryToDecimal(pstadd.substr(1));
    } else {
        cout << "===================Results===================" << endl;
        cout << "Quotient is: " << v[2] << " = " << binaryToDecimal(v[2]) << endl;
        cout << "Remainder is: " << v[1] << " = " << binaryToDecimal(v[1]);
    }
